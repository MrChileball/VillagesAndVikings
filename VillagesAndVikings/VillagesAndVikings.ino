...
int turno = 0;
const byte turnosRecaudacion = 10;

// Direcciones de memoria en la EEPROM para cada variable
#define ADDR_POBLACION 60
#define ADDR_LIMITE_POBLACION 61

#define ADDR_RECURSOS 70
#define ADDR_LIMITE_RECURSOS 71

#define ADDR_DINERO 100
#define ADDR_INGRESO 101

#define ADDR_TURNO 45
#define ADDR_PROBABILIDAD_INVASION 50
...
void manejarComando(String comando) {
  ...
  if (comando == "ayuda" || comando == "a") {
    ...
    turno++;
    construirAlmacen();
    probabilidadInvasion += 8;
  } else if (comando == "expandir" || comando == "e") {
    turno++;
    expandirAldea();
    probabilidadInvasion += 10;
...
void cargarVariablesDesdeEEPROM() {
  ...
  EEPROM.get(ADDR_INGRESO, ingreso);
